...
function [particles, trajectories] = flatsample_uniformmodulating(particles, trajectories, param,amount)
%% function definition
...
%modulate particle energies uniformly
[particles] = modulate_energies(particles,5);
end
