function [particles,trajectories] = monochromaticsource(N, param, Radius, zspacing, beamenergy)
%% Function definition:
...
vdist = vavg + zeros(N); %all particles have same velocity - source is monochromatic
