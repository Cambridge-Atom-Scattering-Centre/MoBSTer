...
N = 10000;
%amount sample modulates
modulation_amount = 5;
%initialise to get the parameters vector and the component structure
[parameters,component] = initialise_calib_invest();

%% simulation


%% source
[particles,trajectories] = monochromaticsource(N,parameters(:,:,1),component(1).radius,100e-3,component(1).beamenergy);
%% hexapole 1
...
%% sample
[particles,trajectories] = flatsample_uniformmodulating(particles,trajectories,parameters(:,:,6),modulation_amount);
%% solenoid 2
